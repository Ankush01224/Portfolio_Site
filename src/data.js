...
export const projects = [
  ...
  { title: 'IP-SAKTI Sahayak', code: '02', status: 'SIH26045', visual: Database, description: 'An AI-powered RAG assistant for Ayurveda IP and regulatory questions, grounded in trusted documents with page citations.', tags: ['RAG', 'Gemini API', 'ChromaDB', 'React'], tone: 'blue', live: 'https://ip-sakti-phi.vercel.app/' },
