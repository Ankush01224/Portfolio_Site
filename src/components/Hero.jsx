...
export default function Hero() {
  ...
  return <section id="home" className="hero" aria-label="Introduction">
    ...
    <div className="container hero-inner">
      ...
      <div className="hero-bottom"><p>Turning curious ideas into useful digital experiences.</p><p>From product UI and APIs to databases and deployment, I enjoy bringing an idea all the way to a working result.</p><div className="hero-socials"><a href={socials.github} target="_blank" rel="noreferrer"><Github /> <span>GitHub</span></a><a href={socials.linkedin} target="_blank" rel="noreferrer"><Linkedin /> <span>LinkedIn</span></a><a href={socials.email}><Mail /> <span>Email</span></a></div></div>
    </div>
  </section>
}
